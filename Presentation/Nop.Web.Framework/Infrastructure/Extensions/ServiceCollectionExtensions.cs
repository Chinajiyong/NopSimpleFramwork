...
namespace Nop.Web.Framework.Infrastructure.Extensions
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static void AddNopAuthentication(this IServiceCollection services)
        {
            ...
            authenticationBuilder.AddJwtBearer(options =>
            {
                options.TokenValidationParameters = new TokenValidationParameters
                {
                    ...
                    ValidIssuer = "http://localhost:15536/",
                    ValidAudience = "api",
                    IssuerSigningKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes("30"))
                };
            });
        ...
        public static IMvcBuilder AddNopMvc(this IServiceCollection services)
        {
            ...
            //add custom global Cors with CorsAuthorizationFilterFactory
            mvcBuilder.AddMvcOptions(options => options.Filters.Add(new CorsAuthorizationFilterFactory("AllowSpecificOrigin")));
